...
def count_logs():
    ...
    top_left_inventory_x = 1689
    top_left_inventory_y = 738
    bottom_left_inventory_x = 1873
    bottom_left_inventory_y = 994

    image_path = "C:\\Users\\oscar\\OneDrive\\Documents\\100daysofcode\\100daysofcode\\woodcutter\\" \
                            "resources\\inventory_logs.PNG"
    inventory = np.array(ImageGrab.grab(bbox=(top_left_inventory_x, top_left_inventory_y, bottom_left_inventory_x, bottom_left_inventory_y
              )))
